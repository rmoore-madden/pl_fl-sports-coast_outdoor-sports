...
if (typeof console != "undefined") { console.log("%c NOTICE: madden-parallax-layout-v1.0.js is deprecated - please use the latest version.", "background:orange; color:black"); }
	...
	$.fn.parallaxLockElement = function (options) {
		...
		return this.each( function() {
			...
			$(window).scroll(function() {
				...
				var parentElBottomViewOffset = (parentElTopViewOffset + parseInt($parentEl.outerHeight(true)));
				...
				if (parentElTopViewOffset <= 0 ) {
					...
					if (parentElBottomViewOffset <= 0) { 
						...
						$this.css({
							...
							"top": (settings.offsetTop + "px"), "margin-top": "0px"
						});
						// call the requested function?
