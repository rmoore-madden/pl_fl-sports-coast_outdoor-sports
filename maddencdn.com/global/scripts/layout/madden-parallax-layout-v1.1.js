...
if (typeof console != "undefined") { console.log("%c NOTICE: madden-parallax-layout-v1.1.js is deprecated - please use the latest version.", "background:orange; color:black"); }
