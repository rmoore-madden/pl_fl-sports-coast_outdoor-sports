 ...
 *
 * 20150423 MADDEN MEDIA: changed options to allow passing of custom GTM object name 
 *	in addition to custom function
 */
;(function ( $, window, document, undefined ) {
  ...
  $.scrollDepth = function(options) {
    ...
    if ( (typeof options.objectHandler !== "undefined") && (typeof options.objectHandler.push === "function") ) {
      // MADDEN MEDIA CHANGGE - support passing in of custom GTM object name
	  standardEventHandler = options.objectHandler.push;
    } else if (typeof options.eventHandler === "function") {
...
// DEBUG
console.log("SCROLL [DATA LAYER]: " + action + ': ' + label);
...
// DEBUG
console.log("SCROLL [GA]: " + action + ': ' + label);
...
// DEBUG
console.log("SCROLL [GAQ]: " + action + ': ' + label);
