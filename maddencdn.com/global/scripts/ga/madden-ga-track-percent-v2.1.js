...
(function() {
	...
	function sendEvent (eventCategory, eventAction, eventLabel, eventValue) {
		...
		// This was the old way of checking for GTM vs Analytics:
		if ((dl != null) && (typeof dl.push === "function") ) {	// It is either NEW analytics or tag manager
		
			if (typeof gtag !== 'undefined'){		// Its new analytics (gtag)
		...
		else {		// Its a legacy version of analytics
