/**
 * v1.4 - Copyright 2016 Madden Media - All rights reserved.
 *
...
initLayout = function (customCallbacks, customElements, calulateChapterHeights) {
	...
	$(".socialShare").each(function () {
		...
		if (url == null) {	
			$(this).attr("href", "javascript:alert('Sharing this site is not currently available.')");			
		} else {
			if (openInDialog) {
				// it's a dialog
				$(this).attr("href", "#");	
...
buildSocialShareLink = function (site, ogImage) {
	...
	if (location.protocol == "file:") {
		var ogLink = $("body").data("online-url");
		var cLink = $("link[rel='canonical']").href;
